      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            if ( prev_size < 2 ) {
                // Creating prev points as we don't have many points
                ...
                // Selecting only last two points
			...
			// Calculating 3 target points in the future (30 away,60 away,90 away)
			...
			// Changing to car co-ordinate system
			...
			// Calculate target point 30 m ahead.
